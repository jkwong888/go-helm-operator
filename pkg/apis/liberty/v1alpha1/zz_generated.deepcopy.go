...
func (in *LibertyAppOidcClientSpec) DeepCopyInto(out *LibertyAppOidcClientSpec) {
	*out = *in
	...
	if in.ClientSecretName != nil {
		in, out := &in.ClientSecretName, &out.ClientSecretName
		*out = new(string)
		**out = **in
	}
...
func (in *LibertyAppOidcClientSpec) DeepCopy() *LibertyAppOidcClientSpec {
	...
	out := new(LibertyAppOidcClientSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LibertyAppSpec) DeepCopyInto(out *LibertyAppSpec) {
	*out = *in
	...
	if in.OidcClient != nil {
		in, out := &in.OidcClient, &out.OidcClient
		*out = new(LibertyAppOidcClientSpec)
		(*in).DeepCopyInto(*out)
	}
